...
<div class="track" data-artist="<? echo htmlspecialchars($Track->artist); ?>" data-track="<? echo htmlspecialchars($Track->track); ?>">
	...
	<div class="header">
		...
		<ul class="details">
			...
			<li><span class="playcount_artist">Artist skrobblad: <span class="count">-</span> gånger</span></li>
			<li><span class="playcount_track">Låt skrobblad: <span class="count">-</span> gånger</span></li>
		</ul>
	</div>
